...
class _InfomationScreenState extends State<InfomationScreen> {
  ...
  Future<void> _loadData() async {
    ...
    setState(() {
      _currentUserName = name != "" ? name : ((currentCustomer?.fullname != null) ? currentCustomer!.fullname! : "Undentified Name");
      _currentUserEmail = email != "" ? email : ((currentCustomer?.email != null) ? currentCustomer!.email! : "Undentified Email");
      _currentUserAvartar = (avatar != "")
          ? avatar
          : ((currentCustomer?.profilePic != null)
              ...
              Column(
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage:
                        (_currentUserAvartar != null && _currentUserAvartar.isNotEmpty) ? NetworkImage(_currentUserAvartar) : NetworkImage(""),
                  ),
                  TextButton(
                      onPressed: () async {
