...
import 'package:washouse_customer/resource/models/center_delivery_price.dart';
...
class _CenterDetailScreenState extends State<CenterDetailScreen> {
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          ...
          if (fromMsg.docs.isEmpty && toMsg.docs.isEmpty) {
            ...
            //   print('peer id: ${center.id}');
            //   print('peer name: ${center.title}');
            //   Navigator.push(
            //     context,
            //     MaterialPageRoute(
            //       builder: (context) {
  ...
  Widget _buildInfoColumn() {
    ...
    bool isHasDelivery = centerArgs.hasDelivery!;
